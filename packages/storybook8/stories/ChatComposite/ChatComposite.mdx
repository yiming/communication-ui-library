...
import { ChatComposite } from '@internal/react-composites';
...
<Meta title="Composites/ChatComposite/Try Chat Composite" />
...
<Source code={'<ChatComposite options={{ topic: false}}>'} />
...
<Source code={'<ChatComposite options={{ participantPane: true}}>'} />
...
<SingleLineBetaBanner />
The Chat Composite supports file sharing capabilities in conjunction with your choice of a storage solution. Please refer
to our [tutorial](https://docs.microsoft.com/azure/communication-services/tutorials/file-sharing-tutorial) for more details.
File sharing in Teams interop scenarios is available with the CallWithChat Composite.
